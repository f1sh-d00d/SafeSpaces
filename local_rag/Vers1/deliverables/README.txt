To run the app, it is simplest to run it via our version hosted online:
https://safeplaces.galister.com/


Otherwise, if you want to run locally, you can follow these steps (Mac and Linux only):
...
3. Open a separate terminal window and run the command "Ollama serve"
...
Currently, there is no support to run this version on Windows


Message me (Fischer Wells) on teams if you have any questions
